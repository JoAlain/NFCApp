...
public class SessionManager {
    ...
    private static final String PREF_NAME = "nfcPref";
    ...
    public void createLoginSession(String token, String nomPrenom, String login, String typeutilisateur, String iduser){
        editor.putBoolean(IS_LOGIN, true);

        editor.putString(KEY_NAME, nomPrenom);

        editor.putString(KEY_ID, iduser);

        editor.putString(KEY_PRIVILEGE, typeutilisateur);
